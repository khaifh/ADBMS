...
new_role = """
CREATE USER khaif@localhost IDENTIFIED BY '1234'
"""

cursor.execute(new_role)

grant_user = """
GRANT student TO khaif@localhost
"""
...
revoke_user = """
REVOKE student FROM khaif@localhost
"""
...
select_user = """
GRANT SELECT ON faculty TO khaif@localhost
"""
